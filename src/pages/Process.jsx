...
export default function Process(){useReveal();return <>
 ...
 <section className="section process-page" data-reveal><div className="shell process-track">{steps.map((s,i)=><article key={s[0]}><span>0{i+1}</span><h2>{s[0]}</h2><p>{s[1]}</p></article>)}</div></section>
